...
// sGuiThemeDefault, sGuiThemeDarker, sGuiTheme::Serialize and sGuiTheme::Tint
// moved to gui/theme.cpp — they are document data, and the document model must
// not have to link the gui manager to reach them.
